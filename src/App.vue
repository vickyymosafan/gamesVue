...
<template>
  ...
  <div class="game-container">
    ...
    <div class="social-links">
      <a href="https://github.com/vickyymosafan" target="_blank" rel="noopener noreferrer" class="social-link">
      ...
      <a href="https://www.linkedin.com/in/vickymosafan/" target="_blank" rel="noopener noreferrer" class="social-link">
        <svg class="social-icon" viewBox="0 0 24 24" fill="currentColor">
